...
REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("issueDate", "dateOfExpiry"),
    ("expiryDate", "dateOfExpiry"),
    ("validUntil", "dateOfExpiry"),

    # snake_case
    ("date_of_issue", "date_of_expiry"),
    ("issue_date", "date_of_expiry"),
...
def main() -> None:
    ...
    print("=" * 72)
    print("MIGRATE TRƯỜNG NGÀY CẤP -> CÓ GIÁ TRỊ ĐẾN")
    ...
    if remaining_old_terms:
        ...
        print()
        print("[OK] Không còn tên trường ngày cấp cũ.")
